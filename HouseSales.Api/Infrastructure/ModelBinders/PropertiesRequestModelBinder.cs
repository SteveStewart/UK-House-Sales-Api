...
{
    public class PropertiesRequestModelBinder : IModelBinder
    {
        public bool BindModel(HttpActionContext actionContext, ModelBindingContext bindingContext)
        {
            PropertiesRequestModel model = bindingContext.Model as PropertiesRequestModel ?? new PropertiesRequestModel();
